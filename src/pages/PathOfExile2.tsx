...
import Sidebar from '../components/SidebarPoe2';
...
// Улучшаем ViewMoreLink для унификации поведения с ServiceCard
...
const PathOfExile2Page: React.FC = () => {
      ...
      <MainContent $sidebarOpen={isSidebarOpen}>
        <AnimatedSection ref={(el) => { if(el) sectionRefs.current[0] = el; }} className="animated-section-marker">
          <SectionContainer>
            ...
            <ServicesGrid>
              <ServiceCard>
                <CardHeader>
                  <h3>PoE 2 Exalted Orbs</h3>
                </CardHeader>
                <CardContent>
                  <CardImage>
                    <img src="/poe2orb.webp" alt="PoE 2 Exalted Orbs" />
                  </CardImage>
                  <FeatureList>
              ...
              <ServiceCard>
                ...
                <CardContent>
                  <CardImage>
                    <img src="/poe2orb2.webp" alt="PoE 2 Divine Orbs" />
                  </CardImage>
                  <FeatureList>
                    <FeatureItem>Choose Any Amount</FeatureItem>
                    <FeatureItem>Quick Delivery</FeatureItem>
              ...
              <ServiceCard>
                <CardHeader>
                  <h3>PoE 2 Unique Items</h3>
                </CardHeader>
                <CardContent>
                  <FeatureList>
                    <FeatureItem>All PoE 2 Uniques</FeatureItem>
                    <FeatureItem>Quick Item Delivery</FeatureItem>
                    <FeatureItem>Low Priced & Safe</FeatureItem>
                  </FeatureList>
                </CardContent>
                <CardFooter>
                  <Price>0<span>50</span>€</Price>
                  <OrderButton>Order now</OrderButton>
                </CardFooter>
              </ServiceCard>
            </ServicesGrid>
        ...
        <AnimatedSection ref={(el) => { if(el) sectionRefs.current[5] = el; }} className="animated-section-marker">
          <CustomOrderSection>
            ...
            <OrderButton>Create custom order</OrderButton>
          </CustomOrderSection>
...
export default PathOfExile2Page; 