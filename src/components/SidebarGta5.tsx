  ...
  return (
    <>
      ...
      <SidebarTitle isOpen={isOpen}>
        <Logo>
          <img src="/gta5logo.png" alt="GTA 5 Logo" />
        </Logo>
        ...
        >
          <SidebarNav>
            <NavSection>
              ...
              <NavList>
                <NavItem>
                  <NavLink to="/games/gta5/money/money-boost">Pure Cash</NavLink>
                </NavItem>
                <NavItem>
                  <NavLink to="/games/gta5/money/money-drop">Cash/Cars</NavLink>
                </NavItem>
                <NavItem>
                  <NavLink to="/games/gta5/money/rank-boost">Custom</NavLink>
                </NavItem>
              </NavList>
            </NavSection>

            <NavSection>
              <SectionTitle>RP Boost</SectionTitle>
              <NavList>
                <NavItem>
                  <NavLink to="/games/gta5/missions/heists">RP Character</NavLink>
                </NavItem>
                <NavItem>
                  <NavLink to="/games/gta5/missions/cayo-perico">RP Bunker</NavLink>
                </NavItem>
                <NavItem>
                  <NavLink to="/games/gta5/missions/doomsday">MAX STATS</NavLink>
                </NavItem>
              </NavList>
            </NavSection>

            <NavSection>
              <SectionTitle>Custom Services</SectionTitle>
              <NavList>
                <NavItem>
                  <NavLink to="/games/gta5/items/vehicles">Modded Cars</NavLink>
                </NavItem>
                <NavItem>
                  <NavLink to="/games/gta5/items/weapons">Modded Outfits</NavLink>
                </NavItem>
                <NavItem>
                  <NavLink to="/games/gta5/items/properties">Custom</NavLink>
                </NavItem>
              </NavList>
            </NavSection>
            ...
            <NavSection>
              ...
              <NavList>
                <NavItem>
                  <NavLink to="/games/gta5/services/account-recovery">Account Recovery</NavLink>
                </NavItem>
                <NavItem>
                  <NavLink to="/games/gta5/services/modding">Modding</NavLink>
                </NavItem>
                <NavItem>
                  <NavLink to="/games/gta5/services/custom">Custom Orders</NavLink>
                </NavItem>
              </NavList>
            </NavSection>
          </SidebarNav>
